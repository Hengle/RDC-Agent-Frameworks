...
- 当前平台状态：$(@{display_name=Manus; status_label=degraded; packaging=workflow-package; capabilities=; coordination_mode=workflow_stage; degradation_mode=workflow-package; cli_discovery_policy=n/a; required_paths=System.Object[]}.status_label)。
- 当前平台生成面：$surfaces。
