...
- 当前平台状态：$(@{display_name=Copilot IDE; status_label=full; packaging=github-agents-plus-mcp; capabilities=; coordination_mode=staged_handoff; degradation_mode=no-native-hooks; cli_discovery_policy=n/a; required_paths=System.Object[]}.status_label)。
- 当前平台生成面：$surfaces。
