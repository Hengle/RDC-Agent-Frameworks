...
- 当前平台状态：$(@{display_name=Claude Code; status_label=full; packaging=project-config-plus-subagents; capabilities=; coordination_mode=concurrent_team; degradation_mode=none; cli_discovery_policy=mcp-discovery-ok,cli-reference-required; required_paths=System.Object[]}.status_label)。
- 当前平台生成面：$surfaces。
