...
description: Internal specialist skill for pass graph, render pipeline, and event-flow investigation within the RenderDoc/RDC GPU debugger workflow. Use when `rdc-debugger` dispatches pipeline causality analysis.
metadata:
  short-description: Pass graph and pipeline specialist
---
