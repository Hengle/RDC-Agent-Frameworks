...
description: Internal specialist skill for final reporting, session artifact curation, and knowledge library updates within the RenderDoc/RDC GPU debugger workflow. Use when `rdc-debugger` dispatches finalization work.
metadata:
  short-description: Report and knowledge curator specialist
---
