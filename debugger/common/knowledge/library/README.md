...
- `sessions/`：session 级 gate artifacts（`.current_session`、`session_evidence.yaml`、`skeptic_signoff.yaml`、`action_chain.jsonl`）
...
- `report.md` 与 `summary.html` 只能引用这里已经成立的证据与结论
