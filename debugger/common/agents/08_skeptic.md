...
#   - knowledge/spec/registry/active_manifest.yaml       （用于核查当前 active invariant 引用的准确性）
...
- 新增第二套 Skeptic gate 文件
- 用 `workspace/` 中的说明替代正式 signoff artifact
